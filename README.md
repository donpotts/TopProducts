...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/donpotts/topproducts/TopProducts.yml?logo=github)
...
1. Clone the repo
  git clone https://github.com/donpotts/TopProducts.git
...
Example:  https://topproducts.azurewebsites.net/swagger
